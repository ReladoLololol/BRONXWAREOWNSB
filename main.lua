...
local WhitelistPage = Instance.new("ScrollingFrame", Main); WhitelistPage.Size = UDim2.new(1, -20, 1, -110); WhitelistPage.Position = UDim2.new(0, 10, 0, 60); WhitelistPage.BackgroundTransparency = 1; WhitelistPage.Visible = false; WhitelistPage.CanvasSize = UDim2.new(0, 0, 3, 0)
...
MakeTab("COMBAT", UDim2.new(0, 2, 0, 5), UDim2.new(0.3, 0, 1, 0), CombatPage)
MakeTab("VISUALS", UDim2.new(0.35, 2, 0, 5), UDim2.new(0.3, 0, 1, 0), VisualPage)
MakeTab("GANG", UDim2.new(0.68, 2, 0, 5), UDim2.new(0.3, 0, 1, 0), WhitelistPage)
...
local function UpdateWL()
    ...
    for _, p in pairs(Players:GetPlayers()) do
        if p ~= LP then
            local b = Instance.new("TextButton", WhitelistPage); b.Size = UDim2.new(1, 0, 0, 30); b.TextColor3 = Color3.new(1, 1, 1); b.Font = Enum.Font.GothamBold; b.Text = p.Name .. (_G.WL[p.Name] and " [SAFE]" or ""); b.BackgroundColor3 = _G.WL[p.Name] and Color3.fromRGB(0, 100, 0) or Color3.fromRGB(30, 30, 30); Instance.new("UICorner", b)
...
--// ⚔️ FINAL ENGINE (FIXED ESP & HITBOX)
    ...
    pcall(function()
        ...
        for _, v in pairs(Players:GetPlayers()) do
            if v ~= LP and v.Character and v.Character:FindFirstChild("HumanoidRootPart") then
                ...
                -- Highlight ESP (Skeleton Replacement)
                if _G.ESP_Skel then
