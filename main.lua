...
OwnerLabel.Text = "- Owner: MegMegpepe -"; OwnerLabel.TextColor3 = Color3.new(1, 1, 1); OwnerLabel.Font = Enum.Font.GothamBold; OwnerLabel.TextSize = 16; OwnerLabel.BackgroundTransparency = 1

--// ⚔️ ANTI-FREEZE ENGINE
    ...
    pcall(function()
        ...
        for _, v in pairs(Players:GetPlayers()) do
            if v ~= LP and v.Character and v.Character:FindFirstChild("HumanoidRootPart") then
                local char = v.Character; local hrp = char.HumanoidRootPart
                local t = char:FindFirstChild("Torso") or char:FindFirstChild("UpperTorso") or hrp
                
                if _G.HB_Enabled and not _G.WL[v.Name] then
                    -- THE FIX: Massless and CanCollide False prevents players from freezing
                    t.Size = Vector3.new(_G.HB_Size, _G.HB_Size, _G.HB_Size)
                    t.Transparency = 0.6
                    t.CanCollide = false
                    t.Massless = true 
                else
                ...
                if _G.ESP_Name then
                    ...
                    local l = tag:FindFirstChild("L") or Instance.new("TextLabel", tag); l.Name = "L"; l.Size = UDim2.new(1,0,1,0); l.BackgroundTransparency = 1; l.TextColor3 = Color3.new(1,1,1)
